...
const Actualizar = () => {
    ...
    return(
        ...
        <form onSubmit={handleSubmit}>
            <h1 className="h3 mb-3 fw-normal" style={{ fontFamily: 'Jersey 10', fontSize: '60px', textAlign: 'center', color: '#8576FF', textShadow: '3px 3px 4px blue', margin: '0 auto 20px' }}>Actualizar</h1>
            ...
            <button className="btn btn-primary w-100 py-2" type="submit"  style={{ display: 'block', margin: '0 auto', fontSize: '30px', padding: '10px 20px', background: '#8576FF', color: 'white', border: 'none', borderRadius: '5px'}}>Actualizar</button>                
        </form>
        </div>
        </div>
