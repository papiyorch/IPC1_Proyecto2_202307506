        ...
        <div className="d-flex flex-column flex-shrink-0 bg-body-tertiary" style={{ width: '4.5rem' }}>
          <ul className="nav nav-pills nav-flush flex-column mb-auto text-center">
            <li className="nav-item">
              <Link to="/admin" className={`nav-link py-3 border-bottom rounded-0 ${activeWindow === 'Home' && 'active'}`} title="Home" data-bs-toggle="tooltip" data-bs-placement="right">
                <svg className="bi pe-none" width="24" height="24" role="img" aria-label="Home"><use xlinkHref="#home"/></svg>
              </Link>
            </li>
            <li>
              <Link to="/create" className={`nav-link py-3 border-bottom rounded-0 ${activeWindow === 'Create' && 'active'}`} aria-current="page" title="Dashboard" data-bs-toggle="tooltip" data-bs-placement="right">
            ...
            <li>
              <Link to="/list" className={`nav-link py-3 border-bottom rounded-0 ${activeWindow === 'posts' && 'active'}`} title="Orders" data-bs-toggle="tooltip" data-bs-placement="right">
            ...
            <li>
              <Link to="/customers" className="nav-link py-3 border-bottom rounded-0" title="Customers" data-bs-toggle="tooltip" data-bs-placement="right">
          ...
          <div className="dropdown border-top">
            ...
            <ul className="dropdown-menu text-small shadow">
              <li><Link className="dropdown-item"  to ="/actualizar" onClick={handleSignOut}>Edit Profile</Link></li>
